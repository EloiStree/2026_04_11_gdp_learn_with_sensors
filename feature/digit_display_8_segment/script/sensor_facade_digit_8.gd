class_name SensorFacadeDigit8
extends Node

@export var set_segment_one_by_one:SensorSetDigit8SegmentOnOff
@export var set_segment_with_char:SensorSetDigit8SegmentWithLetter
...
func set_segment_5(is_on:bool):
	set_segment_one_by_one.set_segment_5(is_on)
